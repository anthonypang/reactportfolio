export const workExperience = [
  {
    ...
    responsibilities: [
      "Developed an AI-powered chat interface, enabling users to ask questions about Looker data and client performance, with query response times under 10 seconds for faster insights.",
      "Reduced MVP delivery time by 50% by pioneering Retool for rapid prototyping, cutting development from 2 weeks to 1 and training team members for faster tool creation.",
      "Ensured 100% data accuracy by optimizing data-fetching workflows with Redux, RTK Query, and GraphQL, improving maintainability and performance.",
      "Decreased feature development time by 10-15% by migrating the component library from Ant Design to a custom Material-UI based library, converting Figma designs into reusable components.",
